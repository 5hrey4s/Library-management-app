...
import { BookOpen, Users, Clock, Search, LogIn, UserPlus } from "lucide-react";
            ...
            <div className="grid gap-8 mt-12 sm:grid-cols-2 lg:grid-cols-4">
              <Card className="transition-transform duration-300 transform hover:scale-105">
                ...
                <CardContent className="text-gray-600 dark:text-gray-400">
                  Effortlessly manage your library's collection with our
              ...
              <Card className="transition-transform duration-300 transform hover:scale-105">
                ...
                <CardContent className="text-gray-600 dark:text-gray-400">
                  Keep track of members, their borrowing history, and
              ...
              <Card className="transition-transform duration-300 transform hover:scale-105">
                ...
                <CardContent className="text-gray-600 dark:text-gray-400">
                  Streamline check-outs, returns, and reservations with our
                  efficient circulation module.
                </CardContent>
              </Card>
              <Card className="transition-transform duration-300 transform hover:scale-105">
                <CardHeader>
                ...
                <CardContent className="text-gray-600 dark:text-gray-400">
                  Find any resource quickly with our powerful and intuitive
